...
import CasinoWc from '../pages/casino/casinoWc'
import InoutWc from '../pages/casino/inoutWc'
import CasinoWcProviders from '../pages/casino/casinoWcProviders'
import CasinoWcSlots from '../pages/casino/casinoWcSlots'
import CasinoWcSports from '../pages/casino/casinoWcSports'
import CasinoWcCrash from '../pages/casino/casinoWcCrash'
import CasinoWcMini from '../pages/casino/casinoWcMini'
        ...
        { path: 'maintenance', element: <h4>Under Main</h4> },
        {
          ...
          children: [
            ...
            { path: '/casino-int/:type', element: <CasinoOther /> },
             { path: '/casino-wc/:type', element: <CasinoWc /> },
          { path: '/wc-casino/:type', element: <CasinoWc /> },
          { path: '/wc-mini/:type', element: <CasinoWcMini /> },
           { path: '/wc-crash/:type', element: <CasinoWcCrash /> },
            { path: '/wc-sports/:type', element: <CasinoWcSports /> },
             { path: '/wc-slots/:type', element: <CasinoWcSlots /> },
              { path: '/wc-providers/:type', element: <CasinoWcProviders /> },
            { path: '/inout-wc/:type', element: <InoutWc /> },
