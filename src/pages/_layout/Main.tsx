...
import SidebarMobile from './elements/sidebarMobile'
        ...
        {!isMobile && (
          <div className='container-fluid '>
            <div className='row'>
              ...
              <div className={!isMobile ? 'col-10 col-lg-10 px-2' : 'col-12 col-lg-12 '} style={{ paddingLeft: !isMobile && location.pathname.includes("casino-in") ? "0px":"", paddingRight: !isMobile && location.pathname.includes("casino-in") ? "0px":""}}>
                <Outlet></Outlet>
              </div>
            </div>
          </div>
